...
import { Copy, Plus, PlusCircle, PlusCircleIcon, Share2, X } from "lucide-react";
 ...
 // 处理分享功能
  ...
  function handleMouseEnter(id: string) {
    ...
    if (card) {
      ...
      // 添加平滑过渡效果
      // card.classList.add('transition-all', 'duration-200', 'ease-in-out');
      // // 可以添加轻微的缩放效果
      // card.classList.add('transform', 'hover:scale-[1.02]');
    }
  }
