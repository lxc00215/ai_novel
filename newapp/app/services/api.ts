...
const apiService = {
  ...
  novels: {
    // 获取小说列表
    getAll: async (): Promise<ApiResponse<Novel[]>> => {
      return request('/novels');
    },
    
    // 获取单个小说
    getById: async (id: string): Promise<ApiResponse<Novel>> => {
      return request(`/novels/${id}`);
    },
    
    // // 创建小说
    // create: async (data: CreateNovelRequest): Promise<ApiResponse<Novel>> => {
    //   return request('/novels', {
    //     method: 'POST',
    //     body: JSON.stringify(data),
    //   });
    ...
    // // 更新小说
    // update: async (id: string, data: Partial<CreateNovelRequest>): Promise<ApiResponse<Novel>> => {
    //   return request(`/novels/${id}`, {
    //     method: 'PUT',
    //     body: JSON.stringify(data),
    //   });
  ...
  ai: {
    ...
    generateImage: async (prompt: string): Promise<ApiResponse<string>> => {
