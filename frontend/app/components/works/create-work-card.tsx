...
export default function CreateWorkCard() {
  return (
    <Card
      className="border border-dashed border-gray-700 bg-background 
    ...
    >
      ...
      {/* 下半部分 - 按钮区域 */}
      <div className="border-t border-dashed border-gray-700 py-4 px-6 flex flex-wrap gap-3 justify-center bg-background">
        <Button
          variant="ghost"
          size="sm"
          className="bg-background text-foreground hover:bg-gray-800 hover:text-white hover:cursor-pointer gap-1 px-4 shadow-sm"
